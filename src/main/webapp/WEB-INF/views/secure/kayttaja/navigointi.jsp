			...
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					...
					<div class="navbar nav_title" style="border: 0;">
						<a href="Etusivu.html" class="site_title"><i class="fa fa-home"></i> <span>Käyttäjä paneeli</span></a>
					</div>
					...
					<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
                				<li><a href="/tunnit_lila/secure/oma/projektit"><i class="fa fa-folder-open-o"></i> Projektit </a></li>
					...
					<div class="sidebar-footer hidden-small">
						<a href="/tunnit_lila/logout" data-toggle="tooltip" data-placement="top" title="Kirjaudu ulos">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  <img src="images/user.png" alt="">Käyttäjä
                  <span class=" fa fa-angle-down"></span>
                </a>
                <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">
                  <li><a href="/tunnit_lila/logout""><i class="fa fa-sign-out pull-right"></i> Kirjaudu ulos</a>
                  </li>
                </ul>
              </li>
            </ul>
